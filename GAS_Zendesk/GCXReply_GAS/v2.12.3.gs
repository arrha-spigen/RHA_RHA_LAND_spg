...
(function () {
  ...
  const SCRIPT_VER = (typeof GM_info !== 'undefined' ? GM_info?.script?.version : null) || '2.12.3';
  ...
  safeAddStyle_(`
    ...
    /* While dragging/resizing: switch to transparent so WebGL canvas shows */
    #sp-order-panel.sp-glass-active { --sp-panel-bg: transparent; }
