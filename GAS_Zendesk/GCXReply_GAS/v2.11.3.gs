...
(function () {
  ...
  const SCRIPT_VER = (typeof GM_info !== 'undefined' ? GM_info?.script?.version : null) || '2.11.3';
  ...
  class GlassWebGL_ {
    ...
    _buildProgram() {
      ...
      const fs = this._shader(gl.FRAGMENT_SHADER, `
        ...
        void main() {
          ...
          // Vertical white-to-grey tint (matches liquid-glass-js reference visual)
    ...
    _startLiveCapture() {
      // Recapture background every 3s so the glass always reflects the current page
