...
(function () {
  ...
  const SCRIPT_VER = (typeof GM_info !== 'undefined' ? GM_info?.script?.version : null) || '2.11.6';
  ...
  class GlassWebGL_ {
    constructor(panel) {
      ...
      // Two captures: 900ms (page settled) + 3500ms (lazy images loaded)
      // No auto-recapture after that — use ⚙ Recapture button for a fresh snapshot
