...
(function () {
  ...
  const SCRIPT_VER = (typeof GM_info !== 'undefined' ? GM_info?.script?.version : null) || '2.10.3';
  ...
  safeAddStyle_(`
    ...
    #sp-minimize-btn, #sp-panel-close { position: relative; z-index: 10000; }
  ...
  function makeDraggable(panel, handle) {
    handle.addEventListener('mousedown', e => {
      if (e.target.closest('#sp-minimize-btn, #sp-panel-close, .sp-re')) return;
      e.preventDefault();
