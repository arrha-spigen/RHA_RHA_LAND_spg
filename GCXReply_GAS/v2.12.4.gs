...
(function () {
  ...
  const SCRIPT_VER = (typeof GM_info !== 'undefined' ? GM_info?.script?.version : null) || '2.12.4';
  ...
  safeAddStyle_(`
    ...
    #sp-order-panel {
      ...
      /* Separate background-color overrides the transparent set by the shorthand above.
         Must appear after `background:` in the same rule to win the cascade. */
