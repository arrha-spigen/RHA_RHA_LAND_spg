...
function chooseGroupFromModel(modelText) {
  ...
  // Handles combo labels like "iPhone 18 Pro Max/18 Pro" — check Pro Max first
  if (model.includes('duo')) return 'iPhone Duo';
  if (model.includes('pro max')) return 'iPhone 18 Pro Max';
  if (model.includes('pro')) return 'iPhone 18 Pro';
