...
function chooseGroupFromModel(modelText) {
  ...
  // Handles combo labels like "Galaxy Z Fold 8 Ultra / Z Fold 7" — check Ultra first
  if (model.includes('fold 8 ultra') || model.includes('fold8 ultra')) return 'Galaxy Z Fold 8 Ultra';
  if (model.includes('flip 8') || model.includes('flip8')) return 'Galaxy Z Flip 8';
  if (model.includes('fold 8') || model.includes('fold8')) return 'Galaxy Z Fold 8';
